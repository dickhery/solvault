import { c as createLucideIcon, r as reactExports, F as useRegisterCollection, G as useUpdateCollection, j as jsxRuntimeExports, b as cn, B as Button, p as LoaderCircle, E as ExternalBlob, H as useComposedRefs$1, I as buttonVariants, d as usePhantom, a as Badge, J as Link, f as useAppConfig, K as useCollections, M as ChevronDown, X, z as Layers, S as Skeleton, N as useUpdateConfig, O as Settings, Q as useDeleteCollection, t as truncateAddress } from "./index-BagE81i5.js";
import { M as Modal, R as Root, T as Trigger, W as WarningProvider, C as Content, a as Title, D as Description, b as Close, c as createDialogScope, d as Portal, O as Overlay, P as Plus } from "./Modal-Da6I10ss.js";
import { L as Label, I as Input, c as composeEventHandlers, a as createSlottable, b as createContextScope } from "./label-EU6hexfy.js";
import { I as ImagePlus, T as Textarea } from "./textarea-hTXPDWr2.js";
import { E as EmptyState } from "./EmptyState-DQo6QAh7.js";
import { C as ChevronUp, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DIBEVs0m.js";
...
const ImageOff = createLucideIcon("image-off", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function AddCollectionModal({
  ...
  async function handleSubmit(e) {
    e.preventDefault();
    if (!form.name.trim() || !form.mintAddress.trim() || !form.metadataProgramAddress.trim())
      return;
    let imageBlob;
    if (imageFile) {
  ...
  const isFormValid = form.name.trim() && form.mintAddress.trim() && form.metadataProgramAddress.trim() && (imageFile || (editing == null ? void 0 : editing.imageBlob));
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      description: editing ? "Update collection details below." : "Register a new Solana NFT collection in the platform.",
      size: "lg",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { children: [
            "Collection Image",
            " ",
            !editing && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
          ] }),
            ...
            "div",
            {
              ...
              children: [
                imagePreview ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-background/60 opacity-0 group-hover:opacity-100 transition-smooth flex items-center justify-center rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground font-medium", children: "Change image" }) })
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Click to upload image" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
          ...
          uploadProgress > 0 && uploadProgress < 100 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-1.5 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "col-mint", children: [
            "Mint Address ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "col-meta", children: [
...
function AccessDenied() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-3xl bg-destructive/10 border border-destructive/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "w-10 h-10 text-destructive/70" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-display font-bold text-foreground mb-2", children: "Access Denied" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs", children: "This page is restricted to the platform administrator." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", "data-ocid": "admin.back_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: "← Back to Portfolio" }) })
      ]
    }
  );
}
...
function AdminSetupGuide() {
  ...
  const hasCollectionPayment = Boolean(
    (_b = config == null ? void 0 : config.collectionPaymentAddress) == null ? void 0 : _b.trim()
  );
  ...
  const hasThresholdKey = Boolean((_c = config == null ? void 0 : config.thresholdKeyName) == null ? void 0 : _c.trim());
  const steps = [
    {
      number: 1,
    ...
    },
    {
      ...
      description: "Set the Solana address users pay when creating collections.",
      detail: "This must be a Solana wallet you fully control. When a user creates a collection, Phantom will prompt them to send the configured SOL fee to this address before the collection is registered in SolVault.",
      isComplete: hasCollectionPayment
    },
    {
      number: 3,
      title: "Configure Marketplace Escrow Wallet",
      description: "Set the address used for marketplace escrow and bid custody.",
      detail: "This is the Solana wallet users send listed NFTs and marketplace bid payments to. Keep a small SOL balance available here to cover outbound transaction fees when NFTs or SOL move back out.",
    ...
    },
    {
      ...
      detail: 'For each collection you need: the collection name, the collection mint address, and the metadata program address (usually the Metaplex Token Metadata program: metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s). Use the "Add Collection" button in the Registered Collections section below.',
      isComplete: hasCollections
    },
    {
      number: 6,
      title: "Set Fees and Threshold Key",
      description: "Configure pricing plus the chain-key name used for app vault addresses.",
      detail: "Platform fee is taken from each marketplace sale (e.g. 2.5%). Collection creation fee is charged in SOL when users create their own NFT collections. Threshold key name controls which chain-key Ed25519 key the backend derives SOL and NFT vault addresses from.",
    ...
    },
    {
      ...
      detail: "Go to Settings and use the collection lookup tool. Paste a registered collection mint address and confirm the app shows the correct per-user NFT vault address for deposits. This verifies your setup is complete.",
      isComplete: hasCollections && isMainnet && hasEscrow && hasCollectionPayment
    }
  ];
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-muted/40 border border-border/50 px-4 py-3 flex items-start gap-2.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground leading-relaxed", children: [
                  ...
                  " ",
                  "Users now see three important addresses in Settings: their Phantom wallet, their app-specific SOL vault, and their app-specific NFT vault. Marketplace escrow and collection payment wallets stay admin-configured separately in this dashboard."
                ] })
              ] }) })
            ]
          },
...
function CollectionRow({
  ...
  const createdDate = new Date(
    Number(collection.createdAt) / 1e6
  ).toLocaleDateString();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.tr,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-muted border border-border overflow-hidden flex-shrink-0", children: imgUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: imgUrl,
              alt: collection.name,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground text-sm truncate", children: collection.name }),
            collection.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate max-w-[200px]", children: collection.description })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 hidden md:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs badge-primary", children: truncateAddress(collection.mintAddress) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 hidden lg:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-muted-foreground", children: truncateAddress(collection.metadataProgramAddress) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 hidden sm:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: createdDate }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 justify-end", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "admin.delete.dialog", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "admin.delete.cancel_button", children: "Cancel" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  AlertDialogAction,
                  {
                    ...
                    children: deleteCollection.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : "Delete"
                  }
                )
              ] })
            ] })
...
function CollectionsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", "data-ocid": "admin.collections.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "w-5 h-5 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-display font-semibold text-foreground", children: "Registered Collections" }),
        collections && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "font-mono text-xs", children: collections.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border overflow-hidden bg-card", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 space-y-3", children: ["col-a", "col-b", "col-c"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    ] }, k)) }) : !(collections == null ? void 0 : collections.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
        icon: Layers,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/60 bg-muted/30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Collection" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide hidden md:table-cell", children: "Mint Address" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide hidden lg:table-cell", children: "Metadata Program" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide hidden sm:table-cell", children: "Created" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: collections.map((col, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CollectionRow,
        {
          collection: col,
          index: i,
...
function ConfigSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", "data-ocid": "admin.config.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "w-5 h-5 text-accent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-display font-semibold text-foreground", children: "App Configuration" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border bg-card p-6", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: ["cfg-a", "cfg-b", "cfg-c", "cfg-d", "cfg-e"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3.5 w-32" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-full" })
    ] }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSave, className: "space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "cfg-mint-fee", children: "Collection Creation Fee (SOL)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "cfg-mint-fee",
              ...
              min: "0",
              step: "0.001",
              value: (current == null ? void 0 : current.collectionCreationFeeSOL) ?? "",
              onChange: (e) => setField(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "cfg-platform-fee", children: "Platform Fee (%)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "cfg-platform-fee",
              ...
              max: "100",
              step: "0.1",
              value: (current == null ? void 0 : current.platformFeePercent) ?? "",
              onChange: (e) => setField(
                "platformFeePercent",
                Number.parseFloat(e.target.value) || 0
              ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "cfg-collection-payment", children: "Collection Payment Wallet Address" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "cfg-collection-payment",
            placeholder: "Solana wallet address for collection fee payments",
            value: (current == null ? void 0 : current.collectionPaymentAddress) ?? "",
            onChange: (e) => setField("collectionPaymentAddress", e.target.value),
            className: "font-mono text-sm",
            "data-ocid": "admin.config.collection_payment_wallet.input"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Users pay the collection creation fee to this Solana address before their collection is created." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "cfg-escrow", children: "Marketplace Escrow Wallet Address" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "cfg-escrow",
            placeholder: "Solana wallet address for marketplace escrow",
            value: (current == null ? void 0 : current.escrowWalletAddress) ?? "",
            onChange: (e) => setField("escrowWalletAddress", e.target.value),
            className: "font-mono text-sm",
            "data-ocid": "admin.config.escrow_wallet.input"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "This wallet receives marketplace escrowed NFTs and bid payments. It should be a Solana wallet you control." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "cfg-threshold-key", children: "Threshold Key Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "cfg-threshold-key",
            placeholder: "dfx_test_key",
            value: (current == null ? void 0 : current.thresholdKeyName) ?? "",
            onChange: (e) => setField("thresholdKeyName", e.target.value),
            className: "font-mono text-sm",
            "data-ocid": "admin.config.threshold_key.input"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "SolVault derives each user's SOL and NFT vault addresses from this chain-key Ed25519 name." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            value: (current == null ? void 0 : current.network) ?? "devnet",
            onValueChange: (v) => setField("network", v),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "admin.config.network.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select network" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "devnet", children: "Devnet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "mainnet-beta", children: "Mainnet Beta" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "testnet", children: "Testnet" })
              ] })
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: updateConfig.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
  ...
  const stats = [
    {
      ...
      value: (collections == null ? void 0 : collections.length) ?? "—",
      icon: Layers
    },
    {
      label: "Active Network",
      value: (config == null ? void 0 : config.network) ?? "—",
      icon: Network
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", "data-ocid": "admin.stats.section", children: stats.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 8 },
      animate: { opacity: 1, y: 0 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { className: "w-5 h-5 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: s.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-display font-bold text-foreground capitalize", children: String(s.value) })
        ] })
      ]
    },
    s.label
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-primary/15 border border-primary/25 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutDashboard, { className: "w-6 h-6 text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-foreground", children: "Admin Dashboard" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-primary/15 text-primary border-primary/25 text-xs font-mono", children: "ADMIN" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Manage NFT collections and app configuration" })
              ] })
            ]
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border/50" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ConfigSection, {})
      ]
    }
  );
}
