const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PortfolioPage-6SjvOlek.js","assets/AddressChip-BI-1VyDm.js","assets/check-BQkykO4m.js","assets/EmptyState-C11XHvsd.js","assets/tag-DnmU2gsS.js","assets/SolAmount-DnuIZtyd.js","assets/backend-DPmPedGg.js","assets/wallet-BOTygLnx.js","assets/trending-up-HnLbIlNS.js","assets/MarketplacePage-DJmQ2_fI.js","assets/input-BQWC2nO7.js","assets/label-lBnrv9wF.js","assets/select-CCBpkAaS.js","assets/index-DI1tdK2w.js","assets/MyCollectionsPage-Cmu6yCnd.js","assets/textarea-CJYmNdZX.js","assets/circle-check-DRhjqAX9.js","assets/AdminPage-DZFeOqiD.js","assets/NftDetailPage-Cp7pf5_S.js","assets/TransactionBadge-VBld94Jy.js","assets/ActivityPage-CiLE_N3E.js","assets/SettingsPage-VGsvY5-s.js"])))=>i.map(i=>d[i]);
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
var ve = (n) => {
  ...
  }, [t.closeButton, et]), Tt = React2.useMemo(() => t.duration || X2 || Wt, [t.duration, X2]), gt = React2.useRef(0), U = React2.useRef(0), St = React2.useRef(0), K = React2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React2.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
...
const PhantomContext = reactExports.createContext(null);
const STORAGE_KEY = "phantom_address";
function PhantomContextProvider({
  children
}) {
  const [address, setAddress] = reactExports.useState(null);
  const [role, setRole] = reactExports.useState("guest");
  const [isConnecting, setIsConnecting] = reactExports.useState(false);
  const hasAutoConnected = reactExports.useRef(false);
  const applyConnection = reactExports.useCallback((addr, userRole) => {
    setAddress(addr);
    setRole(userRole);
  ...
  const disconnect = reactExports.useCallback(() => {
    const solana = window.solana;
    solana == null ? void 0 : solana.disconnect();
    setAddress(null);
    setRole("guest");
  ...
  reactExports.useEffect(() => {
    ...
    const solana = window.solana;
    if (!(solana == null ? void 0 : solana.isPhantom)) return;
    solana.connect({ onlyIfTrusted: true }).then((resp) => {
      const addr = resp.publicKey.toString();
      const existingAdmin = localStorage.getItem("phantom_admin_address");
      const userRole = existingAdmin === addr ? "admin" : "user";
...
function usePhantom() {
  const ctx = reactExports.useContext(PhantomContext);
  if (!ctx)
...
function formatSol(sol, decimals = 4) {
...
function Header({ onMenuClick }) {
  const { address, role, isConnecting, isConnected, connect, disconnect } = usePhantom();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-16 px-4 lg:px-6 flex items-center justify-between bg-card border-b border-border shrink-0 sticky top-0 z-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      role === "admin" && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", "data-ocid": "header.admin_link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          variant: "ghost",
          size: "sm",
      ...
      !isConnected ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            isConnecting ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                width: "16",
                height: "16",
                ...
                role: "img",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Phantom Wallet" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M64 0C28.65 0 0 28.65 0 64s28.65 64 64 64 64-28.65 64-64S99.35 0 64 0zm32.4 86.07c-1.37 1.64-3.82 2.4-7.23 2.4H38.83c-3.41 0-5.86-.76-7.23-2.4-1.23-1.47-1.54-3.56-.93-6.4l7.37-34.5c.77-3.6 3.6-5.75 7.73-5.75h36.46c4.13 0 6.96 2.15 7.73 5.75l7.37 34.5c.6 2.84.3 4.93-.93 6.4z" })
                ]
              }
            ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: truncateAddress(address) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 h-16 border-b border-sidebar-border shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/20 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-4 h-4 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-display font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent", children: "SolVault" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 px-3 py-4 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0.5", children: visibleItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: item.to,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-4 border-t border-sidebar-border space-y-0.5", children: BOTTOM_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: item.to,
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-background overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-w-0 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { onMenuClick: () => setSidebarOpen(true) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 lg:p-6 max-w-screen-2xl mx-auto", children }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      $e,
      {
...
function SkeletonCard({ className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("card-glass overflow-hidden flex flex-col", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "aspect-square w-full rounded-none bg-muted/60" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-2/3 bg-muted/60" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-14 rounded-md bg-muted/60" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-1/2 bg-muted/60" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-1/3 bg-muted/60" })
    ] })
  ] });
}
function SkeletonGrid({ count = 8, className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: cn(
...
const PortfolioPage = reactExports.lazy(() => __vitePreload(() => import("./PortfolioPage-6SjvOlek.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0));
const MarketplacePage = reactExports.lazy(() => __vitePreload(() => import("./MarketplacePage-DJmQ2_fI.js"), true ? __vite__mapDeps([9,6,3,10,11,12,13,2,4,8]) : void 0));
const MyCollectionsPage = reactExports.lazy(() => __vitePreload(() => import("./MyCollectionsPage-Cmu6yCnd.js"), true ? __vite__mapDeps([14,6,10,11,15,16,1,2,3,7]) : void 0));
const AdminPage = reactExports.lazy(() => __vitePreload(() => import("./AdminPage-DZFeOqiD.js"), true ? __vite__mapDeps([17,6,10,11,15,3,12,13,2]) : void 0));
const NftDetailPage = reactExports.lazy(() => __vitePreload(() => import("./NftDetailPage-Cp7pf5_S.js"), true ? __vite__mapDeps([18,1,2,5,19,16,4]) : void 0));
const ActivityPage = reactExports.lazy(() => __vitePreload(() => import("./ActivityPage-CiLE_N3E.js"), true ? __vite__mapDeps([20,3,5,19,16]) : void 0));
const SettingsPage = reactExports.lazy(() => __vitePreload(() => import("./SettingsPage-VGsvY5-s.js"), true ? __vite__mapDeps([21,1,2,11,13]) : void 0));
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonGrid, { count: 8 }) });
}
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PhantomContextProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
export {
  useParams as $,
