import { c as createLucideIcon, r as reactExports, V as React, H as useComposedRefs, j as jsxRuntimeExports, W as ReactDOM, X, b as cn } from "./index-BagE81i5.js";
import { u as useLayoutEffect2, e as Primitive, c as composeEventHandlers, g as dispatchDiscreteCustomEvent, f as useControllableState, b as createContextScope, d as createSlot, h as createContext2 } from "./label-EU6hexfy.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Portal, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Content,
      {
        ...
        children: [
          (title || description) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pt-6 pb-4 border-b border-border", children: [
            title && /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { className: "text-lg font-display font-semibold text-foreground", children: title }),
            description && /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { className: "text-sm text-muted-foreground mt-1", children: description })
          ] }),
