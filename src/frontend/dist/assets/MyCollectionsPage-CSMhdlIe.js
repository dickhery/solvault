import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, b as cn, u as useQuery, k as useQueryClient, m as useMutation, n as getBackendMutationActor, g as getBackendQueryActor, d as usePhantom, w as ue, B as Button, o as formatSol, x as getNetworkLabel, p as LoaderCircle, E as ExternalBlob, y as getPhantomProvider, C as Connection, P as PublicKey, T as Transaction, q as SystemProgram, i as SkeletonGrid, z as Layers, a as Badge } from "./index-BagE81i5.js";
import { M as Modal, P as Plus } from "./Modal-Da6I10ss.js";
import { P as Primitive, L as Label, I as Input } from "./label-EU6hexfy.js";
import { T as Textarea, I as ImagePlus } from "./textarea-hTXPDWr2.js";
      ...
      children: [
        ...
        step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-muted/30 p-5 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-4 space-y-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-muted-foreground", children: collectionPaymentAddress ? `${collectionPaymentAddress.slice(0, 8)}…${collectionPaymentAddress.slice(-6)}` : "Not configured" })
              ] })
            ] })
          ] }),
          !collectionPaymentAddress.trim() && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive leading-relaxed", children: "The admin has not configured a collection payment wallet yet, so collection creation is temporarily unavailable." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground leading-relaxed", children: [
            ...
            " ",
            "to the admin-configured collection payment wallet. The collection will be created immediately after the transaction is confirmed."
          ] }),
...
function MyCollectionsPage() {
  ...
  const collectionPaymentAddress = (config == null ? void 0 : config.collectionPaymentAddress) ?? "";
  const solanaRpcUrl = (config == null ? void 0 : config.solanaRpcUrl) ?? "https://api.devnet.solana.com";
  const network = (config == null ? void 0 : config.network) ?? "devnet";
  if (!isConnected) {
