...
function ecdsa(Point, hash, ecdsaOpts = {}) {
  ...
  function prepSig(message, privateKey, opts) {
    ...
    function k2sig(kBytes) {
      ...
      if (s2 === _0n$4)
        return;
      let recovery = (q2.x === r2 ? 0 : 2) | Number(q2.y & _1n$5);
      let normS = s2;
...
const NftInput = Record({
  "imageBlob": ExternalBlob$1,
  "collectionId": Text,
  "name": Text,
  "description": Text,
  "attributes": Vec(Tuple(Text, Text)),
  "mintAddress": Text
});
const Timestamp = Int;
const AuctionId = Text;
const ListingStatus = Variant({
  "fixedPrice": Nat,
  "auction": AuctionId,
  "unlisted": Null
});
const NftRecord = Record({
  "imageBlob": ExternalBlob$1,
  "ownerAddress": Text,
  "collectionId": Text,
  "name": Text,
...
const Result_5 = Variant({ "ok": NftRecord, "err": Text });
...
const Auction = Record({
  ...
  "bids": Vec(Bid),
  "startsAt": Timestamp,
  "currentHighestBid": Opt(Float64),
  "reservePriceSOL": Float64,
  "currentHighestBidder": Opt(Text),
  "mintAddress": Text,
  "startPriceSOL": Float64,
  "sellerAddress": Text,
  "endsAt": Timestamp
});
const Result_4 = Variant({ "ok": Auction, "err": Text });
const ListingStatus__1 = Variant({
  "active": Null,
  "cancelled": Null,
  "expired": Null,
  "sold": Null
...
const Result_3 = Variant({ "ok": Listing, "err": Text });
const UserCollectionInput = Record({
  "metadataUri": Text,
  "imageBlob": ExternalBlob$1,
  "name": Text,
  "description": Text,
...
const AuctionFilter = Record({
  "status": Opt(AuctionStatus$1),
  "mintAddress": Opt(Text),
  "sellerAddress": Opt(Text)
});
...
const AppConfig = Record({
  "collectionCreationFeeSOL": Float64,
  "solanaRpcUrl": Text,
  "network": Text,
  "escrowWalletAddress": Text,
  "platformFeePercent": Float64
});
const ListingFilter = Record({
  "status": Opt(ListingStatus__1),
  "mintAddress": Opt(Text),
  "sellerAddress": Opt(Text)
});
const Role = Variant({
...
const UserProfile = Record({
  "createdCollections": Vec(Text),
  "joinedAt": Timestamp,
  "role": Role,
  "solanaAddress": Text
});
const Result_1 = Variant({ "ok": Bid, "err": Text });
const CollectionInput = Record({
  "metadataProgramAddress": Text,
  "imageBlob": ExternalBlob$1,
  "name": Text,
  "description": Text,
...
Service({
  ...
  "addNftToUserCollection": Func([Text, NftInput], [Result_5], []),
  "assignCallerUserRole": Func([Principal2, UserRole], [], []),
  "cancelAuction": Func([Text], [Result], []),
  "cancelListing": Func([Text], [Result], []),
  "completeSale": Func([Text, Text, Text], [Result], []),
  "createAuction": Func(
    [Text, Float64, Float64, Nat],
    [Result_4],
    []
  ),
  "createListing": Func([Text, Float64, Nat], [Result_3], []),
  "createUserCollection": Func(
    [UserCollectionInput, Text],
    [Result_2],
    []
  ),
  "deleteCollection": Func([Text], [Result], []),
  "getAuction": Func([Text], [Opt(Auction)], ["query"]),
  "getAuctions": Func(
    [Opt(AuctionFilter)],
    [Vec(Auction)],
    ["query"]
  ...
  "getCollections": Func([], [Vec(Collection)], ["query"]),
  ...
  "getMyRole": Func([], [Role], ["query"]),
  "getNft": Func([Text], [Opt(NftRecord)], ["query"]),
  "getSolanaBalance": Func([Text], [Text], []),
  "getUser": Func([Text], [Opt(UserProfile)], ["query"]),
  "getUserCollections": Func(
    [Text],
    [Vec(UserCollection)],
    ["query"]
  ),
  "getUserNfts": Func([Text], [Vec(NftRecord)], ["query"]),
  ...
  "registerCollection": Func([CollectionInput], [Text], []),
  "registerUser": Func([Text], [Role], []),
  "settleAuction": Func([Text, Text, Text], [Result], []),
  "transform": Func(
    [TransformationInput],
    [TransformationOutput],
    ["query"]
  ),
  "updateCollection": Func([Text, CollectionInput], [Result], []),
  "updateConfig": Func([AppConfig], [Result], []),
  "verifyTransaction": Func([Text], [Text], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const NftInput2 = IDL2.Record({
    "imageBlob": ExternalBlob2,
    "collectionId": IDL2.Text,
    "name": IDL2.Text,
    "description": IDL2.Text,
    "attributes": IDL2.Vec(IDL2.Tuple(IDL2.Text, IDL2.Text)),
    "mintAddress": IDL2.Text
  });
  const Timestamp2 = IDL2.Int;
  const AuctionId2 = IDL2.Text;
  const ListingStatus2 = IDL2.Variant({
    "fixedPrice": IDL2.Nat,
    "auction": AuctionId2,
    "unlisted": IDL2.Null
  });
  const NftRecord2 = IDL2.Record({
    "imageBlob": ExternalBlob2,
    "ownerAddress": IDL2.Text,
    "collectionId": IDL2.Text,
    "name": IDL2.Text,
    "description": IDL2.Text,
    "mintedAt": Timestamp2,
  ...
  const Result_52 = IDL2.Variant({ "ok": NftRecord2, "err": IDL2.Text });
  ...
  const AuctionStatus2 = IDL2.Variant({
    "active": IDL2.Null,
    "cancelled": IDL2.Null,
    "settled": IDL2.Null,
    "pending": IDL2.Null,
  ...
  const Bid2 = IDL2.Record({
    "txSignature": IDL2.Text,
    "placedAt": Timestamp2,
    "amount": IDL2.Float64,
    "bidder": IDL2.Text
  });
  const Auction2 = IDL2.Record({
    "id": IDL2.Text,
    "status": AuctionStatus2,
    "bids": IDL2.Vec(Bid2),
    "startsAt": Timestamp2,
    "currentHighestBid": IDL2.Opt(IDL2.Float64),
    "reservePriceSOL": IDL2.Float64,
    "currentHighestBidder": IDL2.Opt(IDL2.Text),
    "mintAddress": IDL2.Text,
    "startPriceSOL": IDL2.Float64,
    "sellerAddress": IDL2.Text,
    "endsAt": Timestamp2
  });
  const Result_42 = IDL2.Variant({ "ok": Auction2, "err": IDL2.Text });
  const ListingStatus__12 = IDL2.Variant({
    "active": IDL2.Null,
    "cancelled": IDL2.Null,
    "expired": IDL2.Null,
    "sold": IDL2.Null
  ...
  const Listing2 = IDL2.Record({
    "id": IDL2.Text,
    "status": ListingStatus__12,
    "expiresAt": Timestamp2,
    "listedAt": Timestamp2,
    "mintAddress": IDL2.Text,
    "priceSOL": IDL2.Float64,
    "sellerAddress": IDL2.Text
  });
  const Result_32 = IDL2.Variant({ "ok": Listing2, "err": IDL2.Text });
  const UserCollectionInput2 = IDL2.Record({
    "metadataUri": IDL2.Text,
    "imageBlob": ExternalBlob2,
    "name": IDL2.Text,
    "description": IDL2.Text,
    "mintAuthority": IDL2.Text,
    "collectionMintAddress": IDL2.Text,
    "symbol": IDL2.Text
  });
  const UserCollection2 = IDL2.Record({
    "id": IDL2.Text,
    "metadataUri": IDL2.Text,
    "imageBlob": ExternalBlob2,
    "ownerAddress": IDL2.Text,
    ...
    "mintAuthority": IDL2.Text,
    "collectionMintAddress": IDL2.Text,
    "collectionFeeSOL": IDL2.Float64,
    "symbol": IDL2.Text
  });
  const Result_22 = IDL2.Variant({ "ok": UserCollection2, "err": IDL2.Text });
  const AuctionFilter2 = IDL2.Record({
    "status": IDL2.Opt(AuctionStatus2),
    "mintAddress": IDL2.Opt(IDL2.Text),
    "sellerAddress": IDL2.Opt(IDL2.Text)
  });
  const Collection2 = IDL2.Record({
    "id": IDL2.Text,
    "metadataProgramAddress": IDL2.Text,
    "imageBlob": ExternalBlob2,
    "name": IDL2.Text,
    "createdAt": Timestamp2,
    "createdBy": IDL2.Text,
  ...
  const AppConfig2 = IDL2.Record({
    "collectionCreationFeeSOL": IDL2.Float64,
    "solanaRpcUrl": IDL2.Text,
    "network": IDL2.Text,
    "escrowWalletAddress": IDL2.Text,
    "platformFeePercent": IDL2.Float64
  });
  const ListingFilter2 = IDL2.Record({
    "status": IDL2.Opt(ListingStatus__12),
    "mintAddress": IDL2.Opt(IDL2.Text),
    "sellerAddress": IDL2.Opt(IDL2.Text)
  });
  ...
  const UserProfile2 = IDL2.Record({
    "createdCollections": IDL2.Vec(IDL2.Text),
    "joinedAt": Timestamp2,
    "role": Role2,
    "solanaAddress": IDL2.Text
  });
  const Result_12 = IDL2.Variant({ "ok": Bid2, "err": IDL2.Text });
  const CollectionInput2 = IDL2.Record({
    "metadataProgramAddress": IDL2.Text,
    "imageBlob": ExternalBlob2,
    "name": IDL2.Text,
    "description": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "addNftToUserCollection": IDL2.Func([IDL2.Text, NftInput2], [Result_52], []),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "cancelAuction": IDL2.Func([IDL2.Text], [Result2], []),
    "cancelListing": IDL2.Func([IDL2.Text], [Result2], []),
    "completeSale": IDL2.Func([IDL2.Text, IDL2.Text, IDL2.Text], [Result2], []),
    "createAuction": IDL2.Func(
      [IDL2.Text, IDL2.Float64, IDL2.Float64, IDL2.Nat],
      [Result_42],
      []
    ),
    "createListing": IDL2.Func(
      [IDL2.Text, IDL2.Float64, IDL2.Nat],
      [Result_32],
      []
    ),
    "createUserCollection": IDL2.Func(
      [UserCollectionInput2, IDL2.Text],
      [Result_22],
      []
    ),
    "deleteCollection": IDL2.Func([IDL2.Text], [Result2], []),
    "getAuction": IDL2.Func([IDL2.Text], [IDL2.Opt(Auction2)], ["query"]),
    "getAuctions": IDL2.Func(
      [IDL2.Opt(AuctionFilter2)],
      [IDL2.Vec(Auction2)],
      ["query"]
    ),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getCollections": IDL2.Func([], [IDL2.Vec(Collection2)], ["query"]),
    "getConfig": IDL2.Func([], [AppConfig2], ["query"]),
    "getListings": IDL2.Func(
      [IDL2.Opt(ListingFilter2)],
      [IDL2.Vec(Listing2)],
      ["query"]
    ),
    "getMyRole": IDL2.Func([], [Role2], ["query"]),
    "getNft": IDL2.Func([IDL2.Text], [IDL2.Opt(NftRecord2)], ["query"]),
    "getSolanaBalance": IDL2.Func([IDL2.Text], [IDL2.Text], []),
    "getUser": IDL2.Func([IDL2.Text], [IDL2.Opt(UserProfile2)], ["query"]),
    "getUserCollections": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(UserCollection2)],
      ["query"]
    ),
    "getUserNfts": IDL2.Func([IDL2.Text], [IDL2.Vec(NftRecord2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "placeBid": IDL2.Func(
      [IDL2.Text, IDL2.Float64, IDL2.Text, IDL2.Text],
      [Result_12],
      []
    ),
    "registerCollection": IDL2.Func([CollectionInput2], [IDL2.Text], []),
    "registerUser": IDL2.Func([IDL2.Text], [Role2], []),
    "settleAuction": IDL2.Func([IDL2.Text, IDL2.Text, IDL2.Text], [Result2], []),
    "transform": IDL2.Func(
      [TransformationInput2],
      [TransformationOutput2],
      ["query"]
    ),
    "updateCollection": IDL2.Func([IDL2.Text, CollectionInput2], [Result2], []),
    "updateConfig": IDL2.Func([AppConfig2], [Result2], []),
    "verifyTransaction": IDL2.Func([IDL2.Text], [IDL2.Text], [])
  });
};
...
var AuctionStatus = /* @__PURE__ */ ((AuctionStatus2) => {
  AuctionStatus2["active"] = "active";
  AuctionStatus2["cancelled"] = "cancelled";
  AuctionStatus2["settled"] = "settled";
  AuctionStatus2["pending"] = "pending";
  AuctionStatus2["ended"] = "ended";
...
class Backend {
  ...
  async addNftToUserCollection(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async completeSale(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async createAuction(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async createListing(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async createUserCollection(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async placeBid(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async settleAuction(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_AuctionStatus_n26(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n27(_uploadFile, _downloadFile, value);
}
function from_candid_Auction_n24(_uploadFile, _downloadFile, value) {
  return from_candid_record_n25(_uploadFile, _downloadFile, value);
}
async function from_candid_Collection_n52(_uploadFile, _downloadFile, value) {
...
function from_candid_ListingStatus__1_n34(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n35(_uploadFile, _downloadFile, value);
}
function from_candid_ListingStatus_n16(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function from_candid_Listing_n32(_uploadFile, _downloadFile, value) {
  return from_candid_record_n33(_uploadFile, _downloadFile, value);
}
async function from_candid_NftRecord_n13(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n14(_uploadFile, _downloadFile, value);
}
function from_candid_Result_1_n67(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n68(_uploadFile, _downloadFile, value);
}
async function from_candid_Result_2_n38(_uploadFile, _downloadFile, value) {
  return await from_candid_variant_n39(_uploadFile, _downloadFile, value);
}
function from_candid_Result_3_n30(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n31(_uploadFile, _downloadFile, value);
}
function from_candid_Result_4_n22(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n23(_uploadFile, _downloadFile, value);
}
async function from_candid_Result_5_n11(_uploadFile, _downloadFile, value) {
...
function from_candid_Role_n60(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n50(_uploadFile, _downloadFile, value);
}
async function from_candid_UserCollection_n40(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n41(_uploadFile, _downloadFile, value);
}
function from_candid_UserProfile_n63(_uploadFile, _downloadFile, value) {
...
async function from_candid_opt_n61(_uploadFile, _downloadFile, value) {
...
async function from_candid_record_n53(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
...
async function from_candid_variant_n12(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
...
function from_candid_variant_n27(_uploadFile, _downloadFile, value) {
  return "active" in value ? "active" : "cancelled" in value ? "cancelled" : "settled" in value ? "settled" : "pending" in value ? "pending" : "ended" in value ? "ended" : value;
}
...
function from_candid_variant_n35(_uploadFile, _downloadFile, value) {
  return "active" in value ? "active" : "cancelled" in value ? "cancelled" : "expired" in value ? "expired" : "sold" in value ? "sold" : value;
}
async function from_candid_variant_n39(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
...
function from_candid_vec_n48(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Auction_n24(_uploadFile, _downloadFile, x2));
}
async function from_candid_vec_n51(_uploadFile, _downloadFile, value) {
  return await Promise.all(value.map(async (x2) => await from_candid_Collection_n52(_uploadFile, _downloadFile, x2)));
}
function from_candid_vec_n59(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Listing_n32(_uploadFile, _downloadFile, x2));
}
async function from_candid_vec_n65(_uploadFile, _downloadFile, value) {
  return await Promise.all(value.map(async (x2) => await from_candid_UserCollection_n40(_uploadFile, _downloadFile, x2)));
}
async function from_candid_vec_n66(_uploadFile, _downloadFile, value) {
  return await Promise.all(value.map(async (x2) => await from_candid_NftRecord_n13(_uploadFile, _downloadFile, x2)));
}
function to_candid_AuctionFilter_n44(_uploadFile, _downloadFile, value) {
  return to_candid_record_n45(_uploadFile, _downloadFile, value);
}
function to_candid_AuctionStatus_n46(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n47(_uploadFile, _downloadFile, value);
}
async function to_candid_CollectionInput_n69(_uploadFile, _downloadFile, value) {
...
function to_candid_ListingFilter_n55(_uploadFile, _downloadFile, value) {
  return to_candid_record_n56(_uploadFile, _downloadFile, value);
}
function to_candid_ListingStatus__1_n57(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n58(_uploadFile, _downloadFile, value);
}
async function to_candid_NftInput_n8(_uploadFile, _downloadFile, value) {
  return await to_candid_record_n9(_uploadFile, _downloadFile, value);
}
async function to_candid_UserCollectionInput_n36(_uploadFile, _downloadFile, value) {
...
function to_candid_opt_n54(_uploadFile, _downloadFile, value) {
...
async function to_candid_record_n37(_uploadFile, _downloadFile, value) {
  return {
    metadataUri: value.metadataUri,
