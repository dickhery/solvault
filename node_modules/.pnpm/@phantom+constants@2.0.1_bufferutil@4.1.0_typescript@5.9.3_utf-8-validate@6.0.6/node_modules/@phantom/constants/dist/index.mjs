...
var DEFAULT_AUTHENTICATOR_ALGORITHM = Algorithm.ed25519;
...
var ANALYTICS_HEADERS = {
  ...
  CLIENT: "x-phantom-client"
  // mcp, chrome, firefox, safari, node, ios, android, etc.
};

// src/environments.ts
var DEFAULT_AUTH_URL = "https://connect.phantom.app/login/start";
var DEFAULT_AUTH_API_BASE_URL = "https://auth.phantom.app";
